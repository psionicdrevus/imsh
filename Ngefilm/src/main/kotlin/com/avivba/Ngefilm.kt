...
open class Ngefilm : MainAPI() {

    override var mainUrl = runBlocking { MainUrlFetcher.getOrFetchUrl() }
    ...
    override val mainPage =
        mainPageOf(
            "/page/%d/?s=&search=advanced&post_type=movie&index=&orderby=&genre=&movieyear=&country=indonesia&quality=" to
                    "Film Indonesia",
    ...
    override suspend fun load(url: String): LoadResponse {
        ...
        return if (tvType == TvType.TvSeries) {
            ...
            }.filterNot { it.name!!.lowercase().startsWith("pilih") }
